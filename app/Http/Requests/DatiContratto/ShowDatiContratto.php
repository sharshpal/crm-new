...
class ShowDatiContratto extends CrmRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        $isValid = Gate::allows('dati-contratto.show');
        ...
        if(Auth::user()->hasRole("Operatore")){
            $isValid &= $dc->crm_user == Auth::user()->id;
        }
