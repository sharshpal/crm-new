...
class FillPermissionsForUpload extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'dati-contratto.upload.attach-on-create',
            'dati-contratto.upload.attach-on-edit',
            'dati-contratto.upload.view-on-show',
            'dati-contratto.upload.can-download',
        ]);

        $permissionsLight = collect([
            'dati-contratto.upload.attach-on-create',
        ]);
