...
class FillPermissionsForVicidialAgentLog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAgentLog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vicidial-agent-log.index',
            'admin.vicidial-agent-log.create',
            'admin.vicidial-agent-log.show',
            'admin.vicidial-agent-log.edit',
            'admin.vicidial-agent-log.delete',
            'admin.vicidial-agent-log.bulk-delete',
        ]);
