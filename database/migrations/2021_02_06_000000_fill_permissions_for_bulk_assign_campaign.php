...
class FillPermissionsForBulkAssignCampaign extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEsito constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.admin-user.bulk-assign-campaign',
            'admin.partner.bulk-assign-campaign',
        ]);
