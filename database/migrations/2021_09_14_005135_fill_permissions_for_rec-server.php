...
class FillPermissionsForRecServer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVicidialServer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rec-server.index',
            'admin.rec-server.create',
            'admin.rec-server.show',
            'admin.rec-server.edit',
            'admin.rec-server.delete',
            'admin.rec-server.bulk-delete',
        ]);
