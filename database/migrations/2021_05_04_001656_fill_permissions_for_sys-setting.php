...
class FillPermissionsForSysSetting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSysSetting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            //'admin.sys-setting',
            'admin.sys-setting.index',
            'admin.sys-setting.create',
            'admin.sys-setting.show',
            'admin.sys-setting.edit',
            'admin.sys-setting.delete',
            'admin.sys-setting.bulk-delete',
        ]);
