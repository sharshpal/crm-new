...
class FillPermissionsForUserTimelog extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-timelog.index',
            'admin.user-timelog.create',
            'admin.user-timelog.show',
            'admin.user-timelog.edit',
            'admin.user-timelog.delete',
            'admin.user-timelog.bulk-delete',
        ]);
