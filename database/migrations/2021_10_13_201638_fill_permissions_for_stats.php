...
class FillPermissionsForStats extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserTimelog constructor.
     */
    public function __construct()
    {
        ...
        $permissionsAll = collect([
            'admin.user-performance.index',
            'dati-contratto.statistiche-esiti.index',
            'dati-contratto.statistiche-esiti.export',
        ]);

        $permissionsSupervisor = collect([
            'admin.user-performance.index',
            'dati-contratto.statistiche-esiti.index'
        ]);

        //Add New permissions
        $this->permissions = $permissionsAll->map(function ($permission) {
            return [
                'name' => $permission,
        ...
        $this->roles = [
            ...
            [
                'name' => 'Partner',
                'guard_name' => $this->guardName,
                'permissions' => $permissionsSupervisor,
            ],
        ];
    }
