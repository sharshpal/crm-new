...
@section('title', trans('admin.dati-contratto.actions.edit', ['name' => $datiContratto->id]))
            ...
            <dati-contratto-form
                ...
                <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit" :action="action"
                    ...
                    <div class="card-header">
                        <i class="fa fa-pencil"></i> {{ trans('admin.dati-contratto.actions.edit', ['name' => $datiContratto->id]) }}
                    </div>
