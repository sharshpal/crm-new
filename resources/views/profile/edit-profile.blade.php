                            ...
                            <div class="col-md-8">
                                <div class="form-group row align-items-center"
                                    ...
                                    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                                        ...
                                        <div v-if="errors.has('first_name')" class="form-control-feedback form-text"
                                             v-cloak>@{{ errors.first('first_name') }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row align-items-center"
                                    ...
                                    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                                        ...
                                        <div v-if="errors.has('last_name')" class="form-control-feedback form-text"
                                             v-cloak>@{{ errors.first('last_name') }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row align-items-center"
                                    ...
                                    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                                        <input type="text" disabled="disabled" v-model="form.email"
                                               v-validate="'required|email'" @input="validate($event)"
                                               class="form-control"
